...
const ASSETS = [
    ...
    './app.js',
    './style.css',
    '../rfxsynths/rgdizi-synth.js',
    '../rfxsynths/rgdizi-synth.wasm',
    '../rfxsynths/dizi-worklet.js',
    '../replugged/worklets/dizi-worklet.js',
...
self.addEventListener('install', (event) => {
    event.waitUntil(
        caches.open(CACHE_NAME).then((cache) => {
            console.log('[ServiceWorker] Caching RGDizi assets');
